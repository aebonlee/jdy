...
## 2026-03-15 (Day 1 - Update 17) — 히어로 타이틀 줄바꿈 조정

### 작업 내역
- 히어로 타이틀에서 "설계합니다." 앞에 `<br>` 추가
- 변경 전: `당신의 커리어를 전략적으로</strong> 설계합니다.`
- 변경 후: `당신의 커리어를 전략적으로</strong><br>설계합니다.`

### 수정된 파일
| 파일 | 변경 내용 |
|------|----------|
| `index.html` | `.hero-title` — "설계합니다." 앞에 `<br>` 삽입 |
